...
import me.storm.volley.model.PostContentListResp;
...
public class GsonRequestActivity extends BaseActivity {
	...
	private Response.Listener<PostContentListResp> responseListener() {
		return new Response.Listener<PostContentListResp>() {
			@Override
			public void onResponse(PostContentListResp response) {
